...
const newArray = videogames.filter((videogame) => {
    let search = videogame.genders;
    return search.find((gendersOne) => gendersOne === 'RPG')
    
});
//console.log(newArray);

const mediaScore = newArray.reduce((acc, game) => acc + game.score, 0);
console.log(mediaScore/newArray.length);