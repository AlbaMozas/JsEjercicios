//Dado el siguiente javascript, usa .find() 
//para econtrar el alien de nombre 'Cucushumushu' 
//y la mutación 'Porompompero'. 
//Una vez que los encuentres, añade la propiedad 
//.mutation al alien con el valor de la mutación encontrada.
...
const alien = aliens.find(({ name }) => name === 'Cucushumushu');
//const mutation = mutations.find(({ name }) => name === 'Porompompero');
//console.log(alien, mutation);
aliens.push(mutations.find(({ name }) => name === 'Porompompero'));
console.log(aliens);